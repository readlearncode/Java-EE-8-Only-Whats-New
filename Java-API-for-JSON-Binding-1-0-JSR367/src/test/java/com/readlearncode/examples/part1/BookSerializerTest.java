...
import com.readlearncode.examples.part1.domain.Book;
...
public class BookSerializerTest {
    ...
    public void givenSerialize_shouldSerialiseBook() {
        ...
        String expectedJson = "{\"com.readlearncode.examples.part1.domain.Book\":{\"author\":\"Alex Theedom\",\"id\":\"SHDUJ-4532\",\"title\":\"Fun with Java\"}}";
